...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-carouselAndServices text-[#4460EF] bg-[url('/frontend/assets/img/background3.png')] bg-cover w-full h-[1285px]">
            <div class="container-services w-full pt-[112px]">
                <div class="container-titdescServices">
                    <div class="container-titleServices text-[#4460EF] text-[74px] ml-[96px] font-[600]">
                        <h2 class="">Services</h2>
                    </div>
                    <div class="container-descServices text-[#9B9B9B] text-[24px] w-[400px] font-[400]">
                        <p class="ml-[96px]">Lorem ipsum dolor sit amet.</p>
                    </div>
                </div>
                <div class="container-cardServices text-[#FFFFFF] mx-[40px] flex justify-start gap-[48px] flex-row h-[460px] mt-[60px]">
                    <div class="flex grow gap-[48px] mx-[40px]">
                        <div class="container-cardServicesItem basis ml-[20px] bg-cover bg-center bg-[url('frontend/assets/img/webDevServices.jpg')] rounded-[12px]">
                        ...
                        <div class=" text-[#4460EF]">
                            <h1 class="text-[31px] font-[600]">Job Description</h1>
                            <ul class="list-disc text-[20px] font-[400] mt-[8px] pl-[36px]">
                                <li>Job Description</li>
                                <li>Job Description</li>
                                <li>Job Description</li>
                            </ul>
                            <h3 class="text-[20px] font-[500] mt-[40px]">Range Hire</h3>
                            <p class="text-[20px] font-[400]">$50</p>
                        </div>
                    </div>
                </div>
            </div>
