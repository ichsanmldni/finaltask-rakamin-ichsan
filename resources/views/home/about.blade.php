...
<html lang="en">
    ...
    <body>
        <div class="container-carouselAndServices text-[#4460EF] w-full pl-[96px] pt-[96px] flex gap-[280px]">
            <div class="container-titDescAboutUs mt-[60px]">
                <div class="container-titleAboutUs">
                    <h1 class="text-[74px] font-[600]">About Us</h1>
                </div>
                <div class="container-descAboutUs mt-[32px]">
                    <ul class="text-[24px] font-[400]">
                        <li>>> Description</li>
                        <li>>> Description</li>
                        <li>>> Description</li>
                        <li>>> Description</li>
            ...
            <div class="container-pictureAboutUs">
                <img class="w-[80%]" src="frontend/assets/img/aboutUs1.png" alt="">
            </div>
        </div>
        <div class="container-pembatas w-full mb-[20px]">
            <img class="w-full" src="frontend/assets/img/pembatas1.png" alt="">
        </div>
        <div>
        </div>
        <div class="container-ourTeam w-full text-[#4460EF]">
            <div class="container-titOurTeam mx-[96px]">
                <h1 class="text-[74px] font-[600]">Our Team</h1>
            </div>
            <div class="container-curvedCarouselOurTeam flex w-full my-[40px]">
                <div class="flex mx-[20px]">
                    <button class=""><img src="frontend/assets/img/previous.png" alt=""></button>
                </div>
                <section class="">
                    <div class="wrapper">
                        <img src="frontend/assets/img/durmuji.png" alt="">
                        <img src="frontend/assets/img/ichsan.png" alt="">
                        <img src="frontend/assets/img/yusuf.png" alt="">
                        <img src="frontend/assets/img/raid.png" alt="">
                        <img src="frontend/assets/img/adit.png" alt="">
                        <img src="frontend/assets/img/durmuji.png" alt="">
                        <img src="frontend/assets/img/ichsan.png" alt="">
                        <img src="frontend/assets/img/yusuf.png" alt="">
                        <img src="frontend/assets/img/raid.png" alt="">
                ...
                <div class="flex mx-[20px]">
                    <button class=""><img src="frontend/assets/img/next.png" alt=""></button>
                </div>
            </div>
        </div>
        <div class="container-navBarAndOurTeam">
            <div class="container-navBar rounded-xl shadow backdrop-blur-lg w-full fixed top-0 left-0 text-[#4460EF]">
        ...
        <div class="container-FAQ w-full">
            <div class="container-titFAQ ml-[96px]">
                <h1 class="text-[74px] text-[#4460EF] font-[600]">FAQ</h1>
            </div>
            <div class="container-bodyFAQ flex px-[96px] gap-[64px]">
                <div class="container-imgFAQ">
                    <img class="" src="frontend/assets/img/FAQ.png" alt="">
                </div>
                <div class="container-listFAQ grow">
                    <div class="listFAQ flex justify-between p-[24px] shadow-md rounded-lg my-[8px]">
                        <h1 class="text-[16px] font-[700]">Block Title</h1>
                        <img src="frontend/assets/img/plus.png" alt="">
                    </div>
                    <div class="listFAQ flex justify-between p-[24px] shadow-md rounded-lg my-[8px]">
                        <h1 class="text-[16px] font-[700]">Block Title</h1>
                        <img src="frontend/assets/img/plus.png" alt="">
